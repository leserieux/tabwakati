              ...
              <tbody>
                {toCheck.rows.map((t) => (
                  <tr key={t.id}>
                    ...
                    <Td label="Statut">
                      {t.status === "failed" ? <Pill tone="bad">Échec</Pill> : ["completed", "succeeded", "success", "successful"].includes(t.status) ? <Pill tone="ok">Réussi</Pill> : <Pill tone="warn">En attente</Pill>}
                    </Td>
                  </tr>
                ))}
              </tbody>
